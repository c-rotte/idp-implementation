...
uint64_t kDefaultV4UDPSendPacketLen = 1252;
uint64_t kDefaultV6UDPSendPacketLen = 1232;
uint16_t kDefaultUDPSendPacketLen = 1232;

uint16_t kDefaultMaxUDPPayload = 1472;
