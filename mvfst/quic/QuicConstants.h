...
extern uint64_t kDefaultV4UDPSendPacketLen;
extern uint64_t kDefaultV6UDPSendPacketLen;
extern uint16_t kDefaultUDPSendPacketLen;
// The max we will tolerate a peer's max_packet_size to be.
extern uint16_t kDefaultMaxUDPPayload;
...
enum class QuicVersion : uint32_t {
  ...
  // https://www.ietf.org/archive/id/draft-ietf-quic-v2-10.html#name-version-field-2
  QUIC_V2 = 0x6b3343cf
};
...
constexpr auto kDefaultIdleTimeout = 600000ms;
...
// Disabled by default
constexpr uint32_t kDefaultMaxDatagramFrameSize = 65535;
constexpr uint32_t kMaxDatagramFrameSize = 65535;
// Maximum overhead for a QUIC packet containing a single datagram frame
// i.e. Max Short Header + Max Datagram Frame Header
constexpr uint32_t kMaxDatagramPacketOverhead = 25 + 16;
