...
DEFINE_int32(max_send_packet_size,
             quic::kDefaultUDPSendPacketLen,
             "Max UDP QUIC packet size to send");
...
void initializeTransportSettings(HQToolParams& hqUberParams) {
  ...
  MasqueService::setQUICPacketLenV4(FLAGS_max_send_packet_size);
  hqParams.transportSettings.canIgnorePathMTU = true;
  hqParams.transportSettings.numGROBuffers_ = FLAGS_num_gro_buffers;
  hqParams.transportSettings.pacingEnabled =
      FLAGS_pacing || hqParams.transportSettings.defaultCongestionController !=
  ...
  hqParams.transportSettings.advertisedInitialMaxStreamsBidi = 999999;
  hqParams.transportSettings.advertisedInitialMaxStreamsUni = 999999;
